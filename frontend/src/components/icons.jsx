...
export const IconFlow = (p) => <svg {...s(p)}><rect x="2" y="9" width="6" height="6" rx="1.5" /><rect x="16" y="3" width="6" height="6" rx="1.5" /><rect x="16" y="15" width="6" height="6" rx="1.5" /><path d="M8 12h3a2 2 0 0 0 2-2V8a2 2 0 0 1 2-2h1" /><path d="M13 12v4a2 2 0 0 0 2 2h1" /></svg>;
export const IconEye = (p) => <svg {...s(p)}><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12z" /><circle cx="12" cy="12" r="3" /></svg>;
export const IconEyeOff = (p) => <svg {...s(p)}><path d="M9.9 4.2A9.8 9.8 0 0 1 12 4c6.5 0 10 8 10 8a17.6 17.6 0 0 1-2.2 3.3" /><path d="M6.6 6.6C3.9 8.4 2 12 2 12s3.5 7 10 7a9.7 9.7 0 0 0 5.4-1.6" /><path d="M14.1 14.1a3 3 0 0 1-4.2-4.2" /><path d="M2 2l20 20" /></svg>;
...
export const IconDownload = (p) => <svg {...s({ size: p.size || 16 })}><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><path d="M7 10l5 5 5-5" /><path d="M12 15V3" /></svg>;
...
export const IconArrowLeft = (p) => <svg {...s({ size: p.size || 14 })}><path d="M19 12H5" /><path d="M11 6l-6 6 6 6" /></svg>;
export const IconPin = (p) => <svg {...s({ size: p.size || 16 })} fill={p.filled ? 'currentColor' : 'none'}><path d="M9 4h6l-1 6 3 3v2H7v-2l3-3z" /><path d="M12 15v5" /></svg>;
